...
async function findDealByContactId(contactId) {
  ...
  // Toma el deal más recientemente modificado si hay varios asociados.
 ...
 * @param {string} dealId
 * @param {string} proyecto - Debe coincidir con una opción válida de la propiedad "proyecto" en HubSpot.
 */
...
function leerUltimoIndice() {
  try {
    ...
    return -1; // Si el archivo no existe todavía, empieza desde el principio.
  }
}
 ...
 * @param {string[]} params.documentos - Lista de documentos requeridos.
 */
