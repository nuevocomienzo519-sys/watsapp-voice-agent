...
/**
 * Convierte texto a audio (wav, sin compresión con pérdida) usando OpenAI.
 * Se pide wav en vez de mp3 para evitar comprimir el audio dos veces
 * (una en OpenAI y otra al convertirlo a ogg/opus para WhatsApp).
 * @param {string} text - Texto a sintetizar.
 * @returns {Promise<Buffer>} - Buffer de audio en formato wav.
 */
